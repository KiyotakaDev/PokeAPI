...
const NavBar = () => {
  ...
  return (
    <div className="absolute flex justify-evenly items-center w-full py-5 px-8 gap-x-4 transform transition duration-500">
      <div className="w-[40%]">
        <img className="h-auto w-full" src="/pokeapi-logo.png" />
      </div>

      <form
        className="w-[60%] flex justify-between items-center border-2 border-pokemon-purple-50 rounded-lg py-2 px-4 gap-x-6"
